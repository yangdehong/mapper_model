...
public class ModelConstant {
    ...
    // 包路径
    public static final String ROOT_PATH = "model/";
    // 普通写法的类
    public static final String CONTROLLER_NAME = "XController";
    public static final String SERVICE_NAME = "XService";
    public static final String SERVICE_IMPL_NAME = "XServiceImpl";
    public static final String MAPPER_NAME = "XMapper";
